                ...
                <div className={styles.subConteiner}>
                   ...
                   <Botton  
                    ...
                    <ul>
                        ...
                        <br />
                        <li className={`${styles.paragraph}`}>
                            <b>PROJETO ESCOTEIRO DEV</b>: A presente projeto é oferecido pelo 19º Grupo Escoteiro Coqueiral, tem a fim a finalidade de atender a uma demanda educativa no ramo de conhecimento Ciência e Tecnologia, e em decorrência do nosso comprometimento com os ODSs (Objetivos de Desenvolvimento Sustentáveis - https://brasil.un.org/pt-br), em especial o ODS 4 (Educação de qualidade) e ODS 9 (Indústria, inovação e infraestrutura), e ODS (Tecnologia) 17.8. Visando proporcionar a nossa comunidade mais opções de educação com viés tecnológico que seja acessível a todos, o 19º GE Coqueiral abriu vagas para interessados da comunidade (não escoteiros) para serem beneficiados por esse projeto.
                            o todo projeto em início existem desafios a serem superados, como a falta de um local apropriado para as aulas pois atualmente usamos uma sala emprestada no curso de inglês uma vez que nossa sala na sede escoteira não tem ar condicionado e sistema de projeção digital como TV ou tela de projeção e pelo motivo da sede ser exposta diariamente ao sol intenso o que causa uma temperatura bem elevada nas salas o que é bem desagradável para os jovens e voluntários.
                        </li>
                    </ul>
                </div>
            </div>
