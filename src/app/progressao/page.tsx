        ...
        <Section customClass={['flexCollTop', 'fullWidth']}>
            ...
            <div className={styles.conteiner}>
                ...
                <div className={styles.subConteiner}>
                    ...
                    <ul>
                        <li className={styles.paragraph}>Pela participação em diversas Atividades;</li>
                        <li className={styles.paragraph}>Com atividades junto aos outros;</li>
                        <li className={styles.paragraph}>Com atividades dentro e fora do Movimento;</li>
                        <li className={styles.paragraph}>Fazendo coisas no dia-a-dia e não fazendo provas;</li>
                        <li className={styles.paragraph}>Realizando atividades com sucesso, mas também quando as atividades não acontecem como planejamos.</li>
                    </ul>
                    <p className={styles.paragraph}>
                ...
                <div className={styles.subConteiner}>
                    ...
                    <ul>
                        <li className={styles.paragraph}>Especialidades</li>
                        <li className={styles.paragraph}>
