...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    try {
        ...
        return [
            ...
            { url: `${baseUrl}/projetos`, lastModified: new Date().toISOString() },
            { url: `${baseUrl}/projetos/escoteiro-dev`, lastModified: new Date().toISOString() },
            { url: `${baseUrl}/projetos/dia-de-semear-paz`, lastModified: new Date().toISOString() },
            { url: `${baseUrl}/projetos/escoteiros-pela-biodiversidade`, lastModified: new Date().toISOString() },
            { url: `${baseUrl}/projetos/acampa-canoa`, lastModified: new Date().toISOString() },
            { url: `${baseUrl}/projetos/pipa-escoteira`, lastModified: new Date().toISOString() },
